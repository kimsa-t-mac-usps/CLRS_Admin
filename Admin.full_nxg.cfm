...
<!---
<!--- Test for former Ee: Jim Schlett KV83HK / schletjg --->
<cfset RespondingUser_Id = "schletjg">
--->
...
<CFSET LatestReportDate = '06/30/2018'>
<cfoutput>
#LatestReportDate#
</cfoutput>
...
<br>
<!---
GAC - 06/20/2013 - Changed link to new location
<a href="/InHouse/ContingentLiabilities/Report.cfm" target="_blank">Contingent Liabilities and Receivables</a>
--->

<a href="/ClientService/ContingentLiabilities/V1.0/Report.cfm" target="_blank">Contingent Liabilities and Receivables</a>
...
<!---
GAC - 07/17/2013 - Changing link to src to a common area where we know that the code in this folder is used by different pages
...
<iframe id="ThisIFrame" src="/common/setTestUser.cfm" width="70%" height="30pt" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" style="padding:3pt">
</iframe>
...
<CFOUTPUT>
<!---
<a href="https://lawdept.usps.gov/InHouse/ContingentLiabilities/V1.0/Report.cfm###Get_Latest_Update.PRIMARYKEY#" target="_blank">#Get_Latest_Update.CASE_NAME#</a>
GAC - 06/21/2013 - Changed link location and server to #This_Server# so we stay on same server
...
<a href="https://eagnmnss0b6/ClientService/ContingentLiabilities/V1.0/Report.cfm###Get_Latest_Update.PRIMARYKEY#" target="_blank">#Get_Latest_Update.CASE_NAME#</a>
--->
...
<li><b>Tom Marshall's</b> Request Package:
<p><ol type="1">
<li><b>Folder</b>:
<br>
<CFOUTPUT>
...
NOTE: Filename above does not exist <i>on this server</i>.
<br>
...
<CFOUTPUT>
<input type="hidden" name="MAGRequest_FileName" value="#Default_MAGFilename#">
</cfoutput>
...
<div style="border:thin solid orange; padding:5pt">
<big><b>For End-of-Year Report1:</b></big>
