...
<CFIF ThisReportDate GT "10/1/#ThisReportDate_CalYear#" AND ThisReportDate LT "12/1/#ThisReportDate_CalYear#">
...
<!---
<CFSET ThisReportDate_FY_TwoDigit = Right(ThisReportDate_FY, 2)>
--->
...
SELECT lawdepartment.LASTNAME, lawdepartment.FIRSTNAME, lawdepartment.OFFICE, lawdepartment.LONGEMAIL, BUSINESSSERVUSERS.AD_MAILNICKNAME
...
SELECT OFFICE_PRM_KEY, OFFICE AS OFFICE_LDOFFICES
FROM LDOFFICES
...
SELECT DISTINCT lawdepartment.LASTNAME, lawdepartment.FIRSTNAME, lawdepartment.OFFICE, lawdepartment.LONGEMAIL, lawdepartment.PRIMARYKEY, BUSINESSSERVUSERS.AD_USERID, BUSINESSSERVUSERS.AD_MAILNICKNAME, BUSINESSSERVUSERS.CONTINGENT_LIAB_AUTH, LDOFFICES.OFFICE_PRM_KEY, LDPOSITIONSORT.SORTORDER
...
AND (BUSINESSSERVUSERS.AREA LIKE '#Trim_OFFICE_LDOFFICES#%'

OR LAWDEPARTMENT.OFFICE LIKE '#Trim_OFFICE_LDOFFICES#%')
...
<!---
Close <CFIF NOT FileExists(MAGFilePathFilename)>:
--->
</cfif>
