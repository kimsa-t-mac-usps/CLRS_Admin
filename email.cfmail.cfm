...
<CFIF OfficeScope EQ "OfficeOnly"
AND
IsDefined("CONTINGENT_LIAB_GetRecord_Current.RecordCount")
AND
SendTo NEQ ""
AND
ToList NEQ "">
...
<!--- For Production, un-comment CFMAIL TO="#SendTo#" --->
<!---KS TEST 1.22.26 --->
		<!---<CFMAIL 
...
<CFMAIL 
			...
			CC="Kimsa.T.Mac@usps.gov"
		    BCC="Kimsa.T.Mac@usps.gov"
		    SUBJECT="#EmailSubjLine#"
			TYPE="HTML">

<!--- For Production, comment out CFMAIL TO="RPS" --->	


<!---
		<CFMAIL
		    FROM='#This_EE_From_Line#'
		    TO="robert.p.sindermann@usps.gov"
		    SUBJECT="#EmailSubjLine#"
			TYPE="HTML">
--->
...
<!--- For Production, comment out notes #SendTo# --->	
...
<!---
			...
			Trim_OFFICE_LDOFFICES = "#Trim_OFFICE_LDOFFICES#"
...
--->
		...
		<CFIF IsDefined("Sender_TrimEMailAddr") 
		AND 
		Sender_TrimEMailAddr EQ SendTo>
...
<!---            
			<li>Review Tom Marshall�s <a href="https://lawdept.usps.gov/InHouse/ContingentLiabilities/Request.for.Submissions/#Form.MAGRequest_FileName#" target="_blank"><b>memo</b></a> requesting updates for #ThisReportEmailSubjDate#.
--->			
            
            
			<li>Review Keith Weidner's <a href="#Form.GCRequest_FileName#" target="_blank"><b>memo</b></a> requesting updates for #ThisReportEmailSubjDate#.
			...
			<li>Update your cases in the Law Department's <a href="#URL_Scheme##This_Server##V1_URL_Path#Report.cfm" target="_blank"><b>Contingent Liabilities and Receivables Report</b></a>.  <b>Updates need to 
			...
			--->
			<li>The online <a href="#URL_Scheme##This_Server##V1_URL_Path#InsertRecord.cfm" target="_blank"><b>Case Evaluation Checklist</b></a> 
		...
		<CFELSE>
			...
			<CFIF IsDefined("Form.IntroNote_EOY") 
			AND 
			Form.IntroNote_EOY NEQ "">
		...
		You can access the Contingent Liabilities system at this link: <a href="#URL_Scheme##This_Server##V1_URL_Path#Report.cfm" target="_blank"><b>Contingent Liabilities and Receivables Report</b></a>.
		</cfoutput>
		<p>
		If you have any questions about contingent liability matters or procedures, please contact me.
		
		If you have any trouble accessing the report, please e-mail Law Manager Help: BPJGFO@usps.gov
...
<!--- From <CFIF CONTINGENT_LIAB_GetRecord_Current.RecordCount GT 0> --->

<!---
	<CFELSEIF CONTINGENT_LIAB_GetRecord_Current.RecordCount EQ 0 
	AND 
	EndOfYearFlag NEQ "EOY">
--->
...
--->
		...
		--->
		<a href="#URL_Scheme##This_Server##V1_URL_Path#Report.cfm" target="_blank"><b>Contingent Liabilities and Receivables Report</b></a> for future use and reference.
		...
		<li>The online <a href="https://#This_Server#/InHouse/ContingentLiabilities/V1.0/InsertRecord.cfm" target="_blank"><b>Case Evaluation Checklist</b></a> is the only method for adding new cases (including newly reported 
		--->
		<li>The online <a href="#URL_Scheme##This_Server##V1_URL_Path#InsertRecord.cfm" target="_blank"><b>Case Evaluation Checklist</b></a> is the only method for adding new cases (including newly reported 
...
--->
		...
		<a href="#URL_Scheme##This_Server##V1_URL_Path#email.cfmail.nocases.cfm?From=#FromUser#&Office=#Trim_OFFICE_LDOFFICES#&Rpt=#ThisReportDate_CalQuarter#" target="_blank"><b>click here</b></a>
		...
		If you have any trouble accessing the Case Evaluation Checklist, please e-mail Law Manager Help: BPJGFO@usps.gov
...
<!--- Close <CFIF CONTINGENT_LIAB_GetRecord_Current.RecordCount GT 0> --->
	</cfif>


<!--- Close <CFIF OfficeScope EQ "OfficeOnly"> --->
</cfif>
